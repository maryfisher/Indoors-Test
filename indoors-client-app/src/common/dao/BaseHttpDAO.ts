module ind.common.dao {
    ...
    export class BaseHttpDAO {
        ...
        makeCall = <T, U>(method, url: string, params ?: Object,
                          successCallback ?: (response: IHttpPromiseCallbackArg<T>) => U,
                          errorCallback ?: (response: IHttpPromiseCallbackArg<T>) => U): IPromise < T > => {
